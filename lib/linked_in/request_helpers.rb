module LinkedIn
  ...
  module RequestHelpers
    ...
    def profile_options
      ":(id,first-name,last-name,industry,location,num-recommenders,headline,current-status,distance,summary,site-standard-profile-request,picture-url,connections)" #connectons,educations,positions,
    end
